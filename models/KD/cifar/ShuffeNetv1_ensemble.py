...
class ShuffleNet(nn.Module):
    def __init__(self, cfg, num_classes=10):
        ...
        feat_dim = 1024 
        self.aux_layer2 = Aux_Layer1(out_planes[0], feat_dim, num_classes)
        self.aux_layer3 = Aux_Layer2(out_planes[1], feat_dim, num_classes)
...
def create_model(num_classes=100, **kwargs):
    cfg = {"out_planes": [240, 480, 960], "num_blocks": [4, 8, 4], "groups": 3}
    return ShuffleNet(cfg, num_classes=num_classes, **kwargs)
