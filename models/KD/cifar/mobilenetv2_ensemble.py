...
class MobileNetV2(nn.Module):
    ...
    def __init__(self, T, feature_dim, input_size=32, width_mult=1.0, remove_avg=False):
        ...
        feat_dim = 1024
        self.aux_layer2 = Aux_Layer1(output_channels[-3], feat_dim, feature_dim)
        self.aux_layer3 = Aux_Layer2(output_channels[-2], feat_dim, feature_dim)
    ...
    def forward(self, x):
        ...
        features = [features2] + [features3] + [avg]
...
def create_model(num_classes=100):
    model = MobileNetV2(T=6, feature_dim=num_classes, width_mult=0.5)
    return model
