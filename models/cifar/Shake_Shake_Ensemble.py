...
from models.cifar.Shake_Shake_functions import get_alpha_beta, shake_function
...
class Network(nn.Module):
    def __init__(self, config):
        ...
        self.aux_layer2 = Aux_Layer1(n_channels[0], 2048, n_classes)
        self.aux_layer3 = Aux_Layer2(n_channels[1], 2048, n_classes)
    ...
    def forward(self, x):
        ...
        x = self.stage2(x)
        logits3, features3 = self.aux_layer2(x)
